...
public class TscriptParser extends Parser {
	...
	public static final int
		...
		RULE_multiplicativeExpression = 10, RULE_primaryExpression = 11, RULE_relationalExpression = 12, 
		RULE_equalityExpression = 13, RULE_unaryExpression = 14;
	...
	public final AdditiveExpressionContext additiveExpression(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(88); ((AdditiveExpressionContext)_localctx).m = multiplicativeExpression(0);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(93); ((AdditiveExpressionContext)_localctx).r = multiplicativeExpression(0);
					...
					case 2:
						...
						setState(98); ((AdditiveExpressionContext)_localctx).r = multiplicativeExpression(0);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(112); ((MultiplicativeExpressionContext)_localctx).r = primaryExpression();
					...
					case 2:
						...
						setState(115);
						if (!(1 >= _localctx._p)) throw new FailedPredicateException(this, "1 >= $_p");
						setState(116); match(DASH);
						setState(117); ((MultiplicativeExpressionContext)_localctx).r = primaryExpression();
	...
	public final PrimaryExpressionContext primaryExpression() throws RecognitionException {
		...
		try {
			...
			case IDENTIFIER:
				enterOuterAlt(_localctx, 1);
				{
				setState(125); ((PrimaryExpressionContext)_localctx).IDENTIFIER = match(IDENTIFIER);
			...
			case NUMERIC_LITERAL:
				enterOuterAlt(_localctx, 2);
				{
				setState(127); ((PrimaryExpressionContext)_localctx).NUMERIC_LITERAL = match(NUMERIC_LITERAL);
			...
			case STRING_LITERAL:
				enterOuterAlt(_localctx, 3);
				{
				setState(129); ((PrimaryExpressionContext)_localctx).STRING_LITERAL = match(STRING_LITERAL);
			...
			case BOOLEAN_LITERAL:
				...
				{
				setState(131); ((PrimaryExpressionContext)_localctx).BOOLEAN_LITERAL = match(BOOLEAN_LITERAL);
			...
			case NULL_LITERAL:
				...
				{
				setState(133); match(NULL_LITERAL);
			...
			case LPAREN:
				...
				setState(136); ((PrimaryExpressionContext)_localctx).e = expression();
	...
	public final RelationalExpressionContext relationalExpression(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(143); ((RelationalExpressionContext)_localctx).a = additiveExpression(0);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(146);
						if (!(2 >= _localctx._p)) throw new FailedPredicateException(this, "2 >= $_p");
						setState(147); match(LESS);
						setState(148); ((RelationalExpressionContext)_localctx).r = additiveExpression(0);
					...
					case 2:
						...
						setState(151);
						if (!(1 >= _localctx._p)) throw new FailedPredicateException(this, "1 >= $_p");
						setState(152); match(GREATER);
						setState(153); ((RelationalExpressionContext)_localctx).r = additiveExpression(0);
	...
	public final EqualityExpressionContext equalityExpression(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(162); ((EqualityExpressionContext)_localctx).re = relationalExpression(0);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(165);
					if (!(1 >= _localctx._p)) throw new FailedPredicateException(this, "1 >= $_p");
					setState(166); match(DOUBLE_EQUAL);
					setState(167); ((EqualityExpressionContext)_localctx).r = relationalExpression(0);
	...
	public final UnaryExpressionContext unaryExpression() throws RecognitionException {
		...
		try {
			...
			case IDENTIFIER:
				enterOuterAlt(_localctx,